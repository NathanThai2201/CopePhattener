...
myLookAndFeelCope2::myLookAndFeelCope2()
{
    ...
    //(juce::File::SpecialLocationType::hostApplicationPath).getChildFile("BG.png");
    img1 = juce::ImageCache::getFromMemory(BinaryData::Knob2_png, BinaryData::Knob2_pngSize);
}


//==============================================================================
void myLookAndFeelCope2::drawRotarySlider(juce::Graphics& g,
